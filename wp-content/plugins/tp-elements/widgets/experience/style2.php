<div class="circle-text second cus-border border-1 b-second d-center cus-z1 tp-el-text-wrapper">
    ...
    <?php endif; ?>
    <div class="d-flex align-items-center justify-content-center rounded-circle cus-border tp-el-number-wrapper">
        <span class="heading fs-two tp-el-number d-flex align-items-center justify-content-center rounded-circle">
