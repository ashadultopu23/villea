...
class Themephi_Elementor_Blog_Grid_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Description Line Row', 'tp-element'),
                'type' => Controls_Manager::SELECT,
                'default' => 'line-clamp-2',
                'options' => [
                    'line-clamp-1' => esc_html__('One', 'tp-element'),
        ...
        $this->start_controls_section(
            'column_section',
            [
                'label' => esc_html__('Column Settings', 'plugin-name'),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .title:hover' => 'color: {{VALUE}};',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .blog-content p.txt ' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' =>
                '{{WRAPPER}} .themephi-blog-grid .blog-content p.txt ',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .blog-content p.txt ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    // 'inside-border-top-left' => esc_html__( 'Inside Top Left', 'tp_plugin' ),
                    // 'inside-border-top-right'  => esc_html__( 'Inside Top Right', 'tp_plugin' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links span.current' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links span.current' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a:hover' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links span.current' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Box Shadow', 'tp-elements'),
                'selector' => '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links',
                'condition' => [
                    'blog_pagination_show_hide' => 'yes',
                ]
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links a, {{WRAPPER}} .themephi-blog-grid .pagination-area .nav-links span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
?>
        ...
        <div class="themephi-blog-grid2x themephi-blog-grid<?php echo esc_attr($styleClass); ?>">
            ...
            <div class="row blog-gird-item g-4" <?php if ($settings['blog_messonry'] == 'yes') : ?> data-masonry='{ "columnWidth": ".grid-item", "percentPosition": false }' <?php endif; ?>>
