...
class Themephi_Elementor_Team_Slider_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_image_style',
            [
                'label' => esc_html__('Team Image Style', 'tp-elements'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-item .image-wrap img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .team-item .image-wrap img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Team Content Style', 'tp-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );

        $this->add_control(
            'content_hover_bgcolor',
            [
                'label' => esc_html__('Hover Background Color', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content:hover' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'content_height',
            [
                'label' => esc_html__('Content Height', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content .team-name' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-item .team-content .team-name:hover' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}  .team-item .team-content .team-name',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content .team-title' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .team-slider-style4 .team-item .team-content .team-title' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .swiper.team-slider-style5 .tps-team-one-start .inner span' => 'color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .team-content .team-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-inner-wrap:hover .team-content .social-icons a i' => 'color: {{VALUE}};',
        ...
        $this->start_controls_section(
            'icon_section',
            [
                'label' => esc_html__('Icon Section', 'tp-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .social-icons a i' => 'font-size: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .team-socials a i' => 'font-size: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .team-socials a i' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-socials a i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-socials a i:hover' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content .social-icons a' => 'background: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content .social-icons a:hover' => 'background: {{VALUE}};',
        ...
        $this->start_controls_section(
            'navigation_section',
            [
                'label' => esc_html__('Navigation / Pagination ', 'tp-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Pagination Alignment', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'plugin-name'),
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Navigation Dot Size', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'navigation_active_icon_size',
            [
                'label' => esc_html__('Navigation Active Dot Size', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Navigation Border Radius', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'navigation_active_border_radius',
            [
                'label' => esc_html__('Navigation Active Border Radius', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'navigation_dot_color',
            [
                'label' => esc_html__('Navigation Dot Icon Color', 'tp-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            'navigation_dot_icon_active_color',
            [
                'label' => esc_html__('Navigation Dot Icon Active Color', 'tp-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}  .team-swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                var swiper = new Swiper(".tp_team-<?php echo esc_attr($unique); ?>", {
                    ...
                    navigation: {
                        nextEl: ".team-cat-next",
                        prevEl: ".team-cat-prev",
                    },
                    breakpoints: {
                        0: {
