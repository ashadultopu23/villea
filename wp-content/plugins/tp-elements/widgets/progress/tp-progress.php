...
class Themephi_Elementor_Progress_Widget extends \Elementor\Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->add_responsive_control(
			'progress_bar_title_horizontal_position',
			[
				'label' => esc_html__('Title Horizontal Position', 'tp-elements'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%', 'px'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'progress_bar_percent_horizontal_position',
			[
				'label' => esc_html__('Position Horizontal', 'tp-elements'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%', 'px'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'progress_bar_percent_vertical_position',
			[
