<div class="tps-tab-style-one <?php echo $settings['type'];?>">
                ...
                foreach ( $tabs as $index => $item ) :
                    ...
                    <div class="tps-tab-content-one">
                        ...
                        <?php if( $item['btn_text'] ) : ?>
                            <a class="tps-btn btn-primary-2 color-h-black" href="<?php echo esc_url($item['link']['url']);?>" <?php echo esc_attr($target);?>><?php echo $item['btn_text'];?></a>
                        <?php endif; ?>
                    </div>
