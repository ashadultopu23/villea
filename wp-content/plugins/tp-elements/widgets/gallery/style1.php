		<div class="row rs-galleys elementor-image-gallery g-0 <?php echo esc_html($settings['gallery_column_gap']); ?>" data-masonry='{ "columnWidth": ".gallery-masonry-item", "percentPosition": false }'>
		    <?php
            ...
            ?>
		        <div class="col-md-<?php echo esc_html($settings['gallery_columns']); ?> gallery-masonry-item">
