 ...
 * @since 1.3.0
 */
class Themephi_Site_Logo extends Widget_Base
{
	...
	protected function render()
	{
		...
		$has_sticky_img = $settings['stikcy_logo_fallback'] == 'yes' ? 'has_sticky_logo' : '';
			...
			<?php if ($has_caption) : ?>
				...
				<?php if ($link) : ?>
					...
					<div class="hfe-site-logo-set">
						<div class="hfe-site-logo-container <?php echo esc_attr($has_sticky_img); ?>">
