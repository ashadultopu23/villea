	...
	protected function register_controls()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rs-contact-box .address-item .address-icon' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rs-contact-box .address-item.horizontal .address-icon',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .rs-contact-box .address-item:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
