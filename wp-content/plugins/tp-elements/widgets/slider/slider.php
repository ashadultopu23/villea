    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-slider-navigation' => 'justify-content: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            'slider_nav_transform',
            [
                'label' => esc_html__('Navigation Transform X', 'tp-elements'),
                'type' => Controls_Manager::SLIDER,
                'show_label' => true,
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-slider-navigation' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}};',
                ],
                'condition' => ['slider_nav' => 'true', 'tp_slider_style' => ['style2', 'style4',],],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swiper-slide.swiper-slide-active .single--item' => 'background-color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'item_active_content_color',
            [
                'label' => esc_html__('Color', 'tp-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swiper-slide.swiper-slide-active .single--item:hover .slider-title, {{WRAPPER}} .swiper-slide.swiper-slide-active .single--item:hover .slider-subtitle, {{WRAPPER}} .swiper-slide.swiper-slide-active .single--item:hover .desc, {{WRAPPER}} .swiper-slide.swiper-slide-active .single--item:hover .rating-portion i' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swiper-slide.swiper-slide-active .single--item' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .banner-image img, {{WRAPPER}} .info-area .img-area img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .quote-icon' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .quote-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .quote-icon' => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .quote-icon',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .slider-inner-wrapper .tp-el-desc, {{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .review-body .desc',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .review-body .desc',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .slider-inner-wrapper .tp--slider .single--item .review-body .desc' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp--slider .single--item .rating' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp--slider .single--item .rating' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .tp--slider .single--item .tp-el-star' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
?>
        ...
        ?>
        <div class="slider-inner-wrapper position-relative">
        ...
        <?php
        if ($sliderNav == 'true' and ($sstyle != 'style6' && $sstyle != 'style7')) {
            echo '<div class="tp-slider-navigation slider-navigation-' . esc_attr($sstyle) . ' "><div class="tp-slider-prev tps-prev' . esc_attr($unique) . '"><i class="tp tp-arrow-left"></i></div><div class="tp-slider-next tps-next' . esc_attr($unique) . '"><i class="tp tp-arrow-right"></i></div></div>';
        } ?>
