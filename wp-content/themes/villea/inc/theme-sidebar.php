<?php
function villea_widgets_init()
{
	register_sidebar(array(
		'name'          => esc_html__('Default Sidebar', 'villea'),
		'id'            => 'sidebar-1',
	...
	register_sidebar(array(
		'name'          => esc_html__('Service Sidebar', 'villea'),
		'id'            => 'sidebar-service',
		'description'   => esc_html__('This is sidebar area for blog post and single post.', 'villea'),
	...
	if (class_exists('WooCommerce')):
		register_sidebar(array(
			'name'          => esc_html__('WooCommerce Sidebar', 'villea'),
			'id'            => 'woocommerce',
...
add_action('widgets_init', 'villea_widgets_init');
