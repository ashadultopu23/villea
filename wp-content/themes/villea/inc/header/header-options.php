...
if (is_home() && !is_front_page() || is_home() && is_front_page()) {
	...
	$skew_style        = (!empty($villea_option['skew_off'])) ? 'themephi-skew-head' : '';
...
$main_menu_center = (!empty($villea_option['main_menu_center'])) || ($menu_center_page == 'yes')  ? 'main-menu-center' : '';

$main_menu_icon = (!empty($villea_option['main_menu_icon'])) ? 'main-menu-icon-hide' : '';

if ($header_width_meta != '') {
	$header_width = ($header_width_meta == 'full') ? 'container-fluid' : 'container';
} else {
	$header_width = !empty($villea_option['container_layout']) ? $villea_option['container_layout'] : '';
