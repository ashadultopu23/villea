...
if ($post_meta_data == '') {
    if (!empty($villea_option['service_banner_main']['url'])):
        $post_meta_data = $villea_option['service_banner_main']['url'];
    elseif (!empty($villea_option['page_banner_main']['url'])):
        $post_meta_data = $villea_option['page_banner_main']['url'];

    else: {
            $service_banner_bg_color = !empty($villea_option['service_banner_bg_color']) ? $villea_option['service_banner_bg_color'] : '';
...
$service_title = $villea_option['service_title'] ?? '';
...
?>
    ...
    <div class="themephi-breadcrumbs service-breadcrumbs with-bg">
...
<?php } elseif ($post_meta_data2 != '') { ?>
    <div class="themephi-breadcrumbs service-breadcrumbs no-bg">
        <div class="breadcrumbs-single" style="background:<?php echo esc_attr($post_meta_data2); ?>">
            <div class="<?php echo esc_attr($header_width); ?>">
                <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">
                    <div class="row">
...
<?php
    ...
    <?php if ($post_meta_bread == 'show' || $post_meta_bread == '') { ?>
        <div class="themephi-breadcrumbs service-breadcrumbs">
