...
if ($post_meta_data == '') {
    if (!empty($villea_option['blog_banner_main']['url'])):
...
$blog_title = $villea_option['blog_title'] ?? '';
...
?>
    ...
    <div class="themephi-breadcrumbs blog-breadcrumbs with-bg">
...
<?php } elseif ($post_meta_data2 != '') { ?>
    <div class="themephi-breadcrumbs blog-breadcrumbs no-bg">
        <div class="breadcrumbs-single" style="background:<?php echo esc_attr($post_meta_data2); ?>">
            <div class="<?php echo esc_attr($header_width); ?>">
                <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">
                    <div class="row">
...
<?php
    ...
    <?php if ($post_meta_bread == 'show' || $post_meta_bread == '') { ?>
        <div class="themephi-breadcrumbs blog-breadcrumbs ">
