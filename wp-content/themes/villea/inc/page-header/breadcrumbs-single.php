...
if ($post_meta_data == '') {
  if (!empty($villea_option['blog_banner_single']['url'])):
    $post_meta_data = $villea_option['blog_banner_single']['url'];
  elseif (!empty($villea_option['blog_banner_main']['url'])):
    $post_meta_data = $villea_option['blog_banner_main']['url'];
...
<?php if ($post_meta_data != '') {
  $blog_banner_bg_color = !empty($villea_option['blog_banner_bg_color']) ? $villea_option['blog_banner_bg_color'] : '';
...
?>
  ...
  <div class="themephi-breadcrumbs single-common-breadcrumbs with-bg">
...
<?php } elseif ($post_meta_data2 != '') { ?>
  <div class="themephi-breadcrumbs single-common-breadcrumbs no-bg">
    <div class="breadcrumbs-single" style="background: <?php echo esc_attr($post_meta_data2); ?>">
      <div class="<?php echo esc_attr($header_width); ?>">
        <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">
          <div class="row gap-2">
...
<?php
  ...
  <?php if ($post_meta_bread == 'show' || $post_meta_bread == '') { ?>
    <div class="themephi-breadcrumbs single-common-breadcrumbs">
