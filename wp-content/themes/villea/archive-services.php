...
<div id="themephi-blog" class="themephi-blog service-page archive">
    <?php
    ...
    if (!empty($villea_option['service-layout']) || !is_active_sidebar('sidebar-1')) {

        $post_layout = !empty($villea_option['service-layout']) ? $villea_option['service-layout'] : '';
        $post_layout_style = !empty($villea_option['blog_layout_style']) ? $villea_option['blog_layout_style'] : 'grid';
        $blog_grid_columns   =  !empty($villea_option['blog_grid_columns']) ? $villea_option['blog_grid_columns'] : '12';

        if ($post_layout_style == 'grid') {
        ...
        if ($post_layout == 'full') {
            ...
            $col    = '-12';
            $column = 'sidebar-none';
        } elseif ($post_layout == '2left') {
            $layout = 'full-layout-left';
            $col    = '-8';
        } elseif ($post_layout == '2right') {
    ...
    <div class="<?php echo esc_attr($header_width) ?>">
        <div class="row layout-<?php echo esc_attr($layout) ?>">
            <div class="contents-sticky  col-lg<?php echo esc_attr($col); ?> <?php echo esc_attr($layout); ?>">
                ...
                if (!empty($villea_option['service-layout'])) { ?>
                ...
                <div class="tp-shop-items-wrapper tp-shop-item-primary">
                    <div class="tab-content" id="productTabContent">
                                                    ...
                                                    <div class="full-blog-content">
                                                        ...
                                                        if (!empty($villea_option['blog_readmore'])): ?>
                                                            <div class="btn-area mt-20">
                                                                <a href="<?php the_permalink(); ?>" class="box-style box-second d-center d-inline-flex align-items-center gap-2">
                                                                    <span class="fs-six">
                        ...
                        <div class="tab-pane fade <?php echo esc_attr($list_active_content); ?>" id="list-tab-pane" role="tabpanel" aria-labelledby="list-tab" tabindex="0">
                            <div class="tp-shop-list-wrapper tp-shop-item-primary">
                                <!-- new add tab style End    -->
                                <div class="row g-4">
                                    <?php
                                    if (have_posts()) :
